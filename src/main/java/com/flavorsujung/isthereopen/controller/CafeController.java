...
public class CafeController {
    ...
    public void init() {
        ...
        putCafe(cafe);
        cafe = new Cafe();
        cafe.setName("커피베이 성신여대점");
        cafe.setAddress("서울 성북구 보문로34길 80 1층");
        cafe.setRunningTime("매일 10:00 - 23:00");
        cafe.setPhoneNum("0507-1375-2014");
        cafe.setPhotoUrl("http://ldb.phinf.naver.net/20190922_46/1569123521799gJEQg_JPEG/lxoQ7YkH0Y3AyedAkNbeKJK6.jpeg.jpg");
        putCafe(cafe);
        cafe = new Cafe();
        cafe.setName("카페비");
        cafe.setAddress("서울 성북구 보문로30길 71");
        cafe.setRunningTime("매일 11:00 - 24:00");
        cafe.setPhoneNum("02-921-7797");
        cafe.setPhotoUrl("http://ldb.phinf.naver.net/20151104_44/1446627314732yeCEp_JPEG/167054578530574_21.jpg");
        putCafe(cafe);
        cafe = new Cafe();
        cafe.setName("홀슈");
        cafe.setAddress("서울 성북구 보문로34길 88");
        cafe.setRunningTime("오후 12시~오후 8시");
        cafe.setPhoneNum("정보없음");
        cafe.setPhotoUrl("http://ldb.phinf.naver.net/20191002_250/1569986451053OrdX1_JPEG/JcHuVz_SanKstCeTbMuK6O8W.JPG.jpg");
        putCafe(cafe);
        cafe = new Cafe();
        cafe.setName("이디야커피 성신여대점");
        cafe.setAddress("서울 성북구 보문로34길 100");
        cafe.setRunningTime("평일 07:30 - 23:00, 주말 08:00 - 23:00, 공휴일 08:00 - 23:00");
        cafe.setPhoneNum("02-925-3738");
        cafe.setPhotoUrl("http://ldb.phinf.naver.net/20170711_282/1499738599754pJSvu_JPEG/186661513339210_0.jpeg");
        putCafe(cafe);
        cafe = new Cafe();
        cafe.setName("스타벅스 성신여대정문점");
        cafe.setAddress("서울 성북구 보문로34길 62");
        cafe.setRunningTime("08:00 - 21:30");
        cafe.setPhoneNum("1522-3232");
        cafe.setPhotoUrl("http://ldb.phinf.naver.net/20190828_93/1566953601239OT9MQ_PNG/xX7Wv642gXMoTI0DAv0hRymS.png");
        putCafe(cafe);
        cafe = new Cafe();
        cafe.setName("카페온더플랜");
        cafe.setAddress("서울 성북구 동소문로22길 39-4");
        cafe.setRunningTime("매일 08:00 - 05:00");
        cafe.setPhoneNum("02-6215-1020");
        cafe.setPhotoUrl("http://ldb.phinf.naver.net/20190214_234/1550123304569M0StE_JPEG/omHhVGuluiyH3ye3XAnPu2j1.jpg");
        putCafe(cafe);
